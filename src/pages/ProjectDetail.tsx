    ...
    >
      ...
      <div className="relative z-10 px-4 sm:px-6 lg:px-8 max-w-[1920px] mx-auto pb-20 sm:pb-32">
        ...
        <section className="relative flex flex-col items-center pt-32 pb-12 sm:pb-20 text-center">
          ...
          >
            <h1 className="text-4xl sm:text-6xl md:text-8xl lg:text-[8rem] xl:text-[9rem] font-black tracking-tighter text-white uppercase leading-[0.85] mb-6 sm:mb-12">
              {project.name}
            </h1>
        ...
        {/* BACKSTORY & TECH Grid */}
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-10 sm:gap-24 mb-20 sm:mb-40">
          {/* Backstory */}
        ...
        {project.colors && project.font && project.colortheme && (
          <section className="mb-20 sm:mb-40">
            <div className="bg-zinc-900/40 border border-white/5 p-6 sm:p-12 rounded-[2rem] sm:rounded-[2.5rem] relative overflow-hidden">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 relative z-10">
                ...
                <div className="flex flex-col justify-between">
                  <div>
                    ...
                    <div className="bg-black/50 rounded-2xl p-6 border border-white/5 mb-6 overflow-hidden">
                      <p
                        className="text-5xl sm:text-7xl md:text-8xl font-black text-white tracking-tight leading-none mb-4"
        ...
        <section className="border-t border-zinc-800 pt-20 pb-10">
          ...
          >
            ...
            <h2 className="text-3xl sm:text-6xl md:text-8xl font-black text-white uppercase tracking-tighter group-hover:scale-105 transition-transform duration-500 text-center">

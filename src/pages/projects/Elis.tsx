            ...
            <div className="relative w-full aspect-video rounded-[1rem] sm:rounded-[2rem] overflow-hidden border border-white/10 shadow-2xl bg-zinc-900/50 backdrop-blur-sm group">
              ...
              <div className="absolute inset-0 flex items-center justify-center bg-zinc-900/80">
                <div className="text-center space-y-4">
                  <Terminal
                    size={64}
                    className="mx-auto text-cyan-500 opacity-50"
                  />
            ...
            <div>
              ...
              <ul className="space-y-4">
                {project.features.map((feature, idx) => (
                  <li
                    key={idx}
                    className="flex items-start gap-3 text-zinc-400 leading-relaxed group"
                  >
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                {Object.entries(project.stats).map(([key, value]) => (
                  <div
                    key={key}
                    className="p-6 rounded-2xl bg-zinc-900/50 border border-white/5 flex flex-col items-center justify-center text-center group hover:border-[#06b6d4]/50 transition-colors"
                  >
                    ...
                    <span className="text-2xl md:text-3xl font-black text-white mb-2">
                      {value}
                    </span>

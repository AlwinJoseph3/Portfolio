...
const HomeChef = () => {
  ...
  const primaryColor = project.colors?.[0] || "#673Ab7";
  ...
  return (
    <motion.div
      ...
      className="min-h-screen bg-[#020617] selection:bg-[#673Ab7] selection:text-white overflow-x-hidden"
    >
      {/* Scroll Progress Bar */}
      <motion.div
      ...
      <div className="relative z-10 px-4 sm:px-6 lg:px-8 max-w-[1920px] mx-auto pb-20 sm:pb-32">
        ...
        <section className="relative flex flex-col items-center pt-32 pb-12 sm:pb-20 text-center">
          ...
          >
            <button
              onClick={() => navigate("/")}
              className="group flex items-center gap-2 px-4 py-2 rounded-full border border-white/10 bg-black/20 text-xs text-zinc-400 uppercase tracking-widest hover:bg-white/10 hover:text-white transition-all backdrop-blur-sm"
            >
              <ArrowLeft
                size={14}
          ...
          >
            <h1 className="text-5xl sm:text-6xl md:text-8xl lg:text-[8rem] xl:text-[9rem] tracking-tighter text-white uppercase leading-[0.85] mb-8 sm:mb-12">
              {project.name}
            </h1>
            ...
            <div className="max-w-2xl mx-auto">
              ...
              {project.link && (
                <a
                  ...
                  className="inline-flex items-center gap-3 px-8 py-4 bg-white text-black uppercase tracking-widest text-sm rounded-full hover:bg-[#673Ab7] hover:text-white transition-all shadow-xl hover:shadow-[#673Ab7]/20 hover:scale-105 active:scale-95"
                >
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-12 sm:gap-24 mb-24 sm:mb-40">
          ...
          <div className="space-y-6">
            <h3 className="text-2xl text-white uppercase tracking-tighter flex items-center gap-3">
              <span className="w-8 h-[2px] bg-[#673Ab7]" /> The Story
            </h3>
          ...
          <div className="space-y-6">
            <h3 className="text-2xl text-white uppercase tracking-tighter flex items-center gap-3">
              <span className="w-8 h-[2px] bg-[#673Ab7]" /> Tech Stack
            </h3>
            <div className="flex flex-wrap content-start gap-3">
              {project.techStack?.map((tech, idx) => (
                <div
                  key={idx}
                  className="px-4 py-2 rounded-lg border border-white/10 bg-white/5 text-xs sm:text-sm text-zinc-300 uppercase tracking-wide hover:border-[#673Ab7] hover:bg-[#673Ab7]/10 hover:text-white transition-all cursor-default"
                >
                  {tech}
                </div>
              ))}
        ...
        {(project.features || project.architecture || project.stats) && (
          <section className="mb-24 sm:mb-40 grid grid-cols-1 lg:grid-cols-2 gap-12 sm:gap-24">
            {project.features && (
              <div>
                <h3 className="text-2xl text-white uppercase tracking-tighter mb-6 flex items-center gap-3">
                  <span className="w-8 h-[2px] bg-[#673Ab7]" /> Key Features
                </h3>
                <ul className="space-y-4">
                  {project.features.map((feature, idx) => (
                    ...
                    >
                      <span className="w-1.5 h-1.5 rounded-full bg-[#673Ab7] mt-2.5 flex-shrink-0" />
                      <span>{feature}</span>
                    </li>
                  ))}
                </ul>
            ...
            {project.stats && (
              <div>
                <h3 className="text-2xl text-white uppercase tracking-tighter mb-6 flex items-center gap-3">
                  <span className="w-8 h-[2px] bg-[#673Ab7]" /> Impact & Metrics
                </h3>
                <div className="grid grid-cols-2 gap-4">
                  {Object.entries(project.stats).map(([key, value]) => (
                    ...
                    >
                      <span className="text-3xl md:text-4xl text-white mb-2">
                        {value}
                      </span>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 relative z-10">
                ...
                <div>
                  <div className="flex items-center gap-3 mb-8">
                    <div className="p-2 bg-[#673Ab7]/20 rounded-lg text-[#673Ab7]">
                      <Sparkles size={20} />
                    </div>
                    <h3 className="text-2xl sm:text-3xl text-white uppercase tracking-tighter">
                      Color Palette
                    </h3>
                  </div>
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                    {project.colors?.map((color, idx) => (
                      ...
                      >
                        ...
                        >
                          <span className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 bg-black/20 text-white text-[10px] uppercase transition-opacity">
                            Copy
                          </span>
                        </div>
                ...
                <div className="flex flex-col justify-between">
                  <div>
                    ...
                    <div className="bg-black/50 rounded-2xl p-6 border border-white/5 mb-6">
                      <p
                        className="text-6xl sm:text-7xl md:text-8xl text-white tracking-tight leading-none mb-4"
        ...
        {project.screenshots && project.screenshots.length > 0 && (
          <section className="space-y-12 mb-20 sm:mb-32">
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="text-3xl sm:text-5xl text-white uppercase tracking-tighter">
                Visual Highlights
              </h3>
            </div>
        ...
        {nextProject && (
          <section className="border-t border-zinc-800 pt-20 pb-10">
            ...
            >
              ...
              <div className="w-16 h-16 rounded-full border border-white/10 flex items-center justify-center bg-black group-hover:bg-[#673Ab7] group-hover:border-[#673Ab7] transition-all">
                <ArrowLeft
                  size={24}

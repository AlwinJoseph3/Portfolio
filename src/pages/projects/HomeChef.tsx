              ...
              <div className="max-w-2xl mx-auto">
                 ...
                 {project.link && (
                  <a
                    ...
                    className="inline-flex items-center gap-3 px-8 py-4 bg-white text-black font-black uppercase tracking-widest text-sm rounded-full hover:bg-[#673Ab7] hover:text-white transition-all shadow-xl hover:shadow-[#673Ab7]/20 hover:scale-105 active:scale-95"
                  >
           ...
           <div className="space-y-6">
             ...
             <div className="flex flex-wrap content-start gap-3">
                {project.techStack?.map((tech, idx) => (
                  <div
                    key={idx}
                    className="px-4 py-2 rounded-lg border border-white/10 bg-white/5 text-xs sm:text-sm font-bold text-zinc-300 uppercase tracking-wide hover:border-[#673Ab7] hover:bg-[#673Ab7]/10 hover:text-white transition-all cursor-default"
                  >
                    {tech}
                  </div>
                ))}
